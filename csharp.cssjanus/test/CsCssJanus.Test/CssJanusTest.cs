...
namespace CsCssJanus.Test
{
    ...
    public class CssJanusTest
    {
        ...
        /// Flips a stylesheet.
        /// </summary>
        /// <param name="code">code Stylesheet to flip</param> 
        /// <param name="swapLtrRtlInUrl">swapLtrRtlInUrl Swap "ltr" and "rtl" in CSS URLs</param> 
        /// <param name="swapLeftRightInUrl">swapLeftRightInUrl Swap "left" and "right" in CSS URLs</param> 
        /// <returns>Flipped stylesheet</returns>
